...
void Timer::Initialize()
{
	...
	for (int i = 0; i < 20; i++)
	{
		...
		/*if(i<=10)
		ImageManager::SetImagePos(hPictNum_[i], XMFLOAT3(-1300, 900, 0));

		if(i>10)
		ImageManager::SetImagePos(hPictNum_[i], XMFLOAT3(-1400, 900, 0));*/
	}
}
...
void Timer::Update()
{
	...
	ImageManager::SetImagePos(hPictNum_[time_ / 10], XMFLOAT3(-1400, 900, 0));
